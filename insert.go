...
func (this *Builder[T]) CreateSql(value contracts.Fields, insertType2 ...contracts.InsertType) (sql string, bindings []any) {
	if len(value) == 0 {
		return
	}
	keys := make([]string, 0)
...
func (this *Builder[T]) InsertSql(values []contracts.Fields, insertType2 ...contracts.InsertType) (sql string, bindings []any) {
	if len(values) == 0 {
		return
	}
...
func (this *Builder[T]) InsertIgnoreSql(values []contracts.Fields) (sql string, bindings []any) {
	return this.InsertSql(values, contracts.InsertIgnore)
}

func (this *Builder[T]) InsertReplaceSql(values []contracts.Fields) (sql string, bindings []any) {
