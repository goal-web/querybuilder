...
func (this *Builder) Count(fields ...string) contracts.QueryBuilder {
	if len(fields) == 0 {
...
func (this *Builder) Avg(field string, as ...string) contracts.QueryBuilder {
	if len(as) == 0 {
...
func (this *Builder) Sum(field string, as ...string) contracts.QueryBuilder {
	if len(as) == 0 {
...
func (this *Builder) Max(field string, as ...string) contracts.QueryBuilder {
	if len(as) == 0 {
...
func (this *Builder) Min(field string, as ...string) contracts.QueryBuilder {
	if len(as) == 0 {
